...
public class FragmentoRespostaEmail extends Fragment implements OnBackPressedListener {
    ...
    public static FragmentoRespostaEmail newInstance(String param1, String param2) {
        FragmentoRespostaEmail fragment = new FragmentoRespostaEmail();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //putting the values of the inbox clicked
