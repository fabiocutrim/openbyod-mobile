...
import br.edu.ifma.openbyodmobileside.request.EdicaoContatoRequest;
import br.edu.ifma.openbyodmobileside.util.Mascara;
import butterknife.Bind;
import butterknife.ButterKnife;

/**
 * Created by Windows on 25/05/2017.
 */

public class FragmentoEdicaoContato extends Fragment implements OnBackPressedListener {
    ...
    public static FragmentoEdicaoContato newInstance(String param1, String param2) {
        FragmentoEdicaoContato fragment = new FragmentoEdicaoContato();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        id = savedInstanceState.getInt(FragmentoAgenda.ID_CONTATO);
        nome = savedInstanceState.getString(FragmentoAgenda.NOME_CONTATO);
        telefone = savedInstanceState.getString(FragmentoAgenda.TELEFONE_CONTATO);
        email = savedInstanceState.getString(FragmentoAgenda.EMAIL_CONTATO);
        empresa = savedInstanceState.getString(FragmentoAgenda.EMPRESA_CONTATO);
        //Initialization of the Edit Texts
        txtTelefone.addTextChangedListener(Mascara.insert("(##)####-####", txtTelefone));
        //putting the values of the contact clicked
    ...
    public void atualizarContato() {
        ...
        if (cancel) {
            ...
            Contato contato = new Contato(id, nomeContato, telefoneContato,
                    email, empresa);
            ...
            EdicaoContatoRequest request = new EdicaoContatoRequest(activityPrincipal);
            request.atualizaContato(contato);
        }
    }
